...
const TESTIMONIALS = [
  {
    quote: "Ayush delivered exceptional code on the Elite Hotel project. His understanding of microservices is top-notch.",
    name: "Alex Morgan",
    role: "Project Manager, Elite Hotel",
    initials: "AM",
  },
  {
    quote: "The Nxtcart platform is blazing fast. Ayush's optimization skills significantly improved our conversion rates.",
    name: "Sarah Chen",
    role: "CTO, Nxtcart",
    initials: "SC",
  },
