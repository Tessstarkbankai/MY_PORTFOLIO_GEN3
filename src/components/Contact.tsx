    ...
    <section className="relative z-20 bg-[#0a0a0a] py-32 px-4 md:px-12 overflow-hidden" id="contact">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="flex flex-col gap-6 mb-12">
              <a href="mailto:raiayushmaan1092@gmail.com" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                ...
                <span className="text-lg">raiayushmaan1092@gmail.com</span>
              </a>
              
              <div className="flex items-center gap-4">
                 <SocialLink href="https://github.com/tessstarkbankai" icon={<GithubIcon />} label="GitHub" />
                 <SocialLink href="https://linkedin.com/in/ayushrai1092" icon={<LinkedinIcon />} label="LinkedIn" />
                 <SocialLink href="https://twitter.com/" icon={<TwitterIcon />} label="Twitter" />
              </div>
            </div>

            <a 
              href="/MYRESUME_SA.pdf" 
              download 
        ...
        <footer className="mt-24 pt-8 border-t border-white/5 text-center text-gray-500 font-mono text-sm">
           <p>&copy; {new Date().getFullYear()} Ayush_Dev_Verse. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
