...
const ARTICLES = [
  {
    title: "Who I Am",
    excerpt: "I am a Full Stack Developer passionate about building scalable,real-world digital solutions that create impact. My journey in technology is driven by curiosity, problem-solving, and the desire to architect systems that are not just functional, but efficient and production-ready.",
    category: "Journey",
    readTime: "5 min read",
  ...
  {
    title: "Functional Website Modern Businesses",
    excerpt: "In today’s digital-first economy, a functional website is not just a branding asset - it is a core business infrastructure.",
    category: "Tech",
    readTime: "8 min read",
  ...
  {
    title: "Why I picked Next.js for my E-Commerce App",
    excerpt: "Why I picked Next.js for my E-Commerce AppWhen building an e-commerce platform, performance, scalability, and user experience are not optional — they directly influence revenue.",
    category: "Tech",
    readTime: "6 min read",
