...
const TIMELINE_DATA = [
{
  ...
  org: "Freelance & Startup Projects",
  description: "Building scalable, production-ready applications like 'ICRS (Invertis Complaint Raise System)', 'Invertis Auditorium Booking System', and AI-based automation platforms. Expertise in MERN Stack, Next.js, Firebase, Express.js, MongoDB, REST APIs, and Cloud Deployment.",
  type: "work",
}
,
  {
  year: "2023",
  title: "The Deep Dive into Full-Stack Development",
  org: "Self-Led Learning & College Projects",
  description: "Started mastering Web Development and Software Engineering alongside B.Tech CSE. Dedicated extensive hours to learning the MERN stack, building real-world projects like Auditorium Booking System and ICRS, and strengthening core concepts of DSA, DBMS, and Backend Development.",
  type: "milestone",
}
,
  {
  ...
  description: "Pursuing B.Tech CSE with strong focus on Full-Stack Development, Qualifed GATE 2026, Data Structures & Algorithms, DBMS, Computer Networks, and Backend Engineering. Actively building real-world, production-level web applications for university and startup initiatives.",
  type: "education",
}
,
  {
  ...
  org: "CBSE",
  description: "Completed higher secondary education with a strong foundation in Mathematics and Science. Developed analytical and logical thinking skills that later strengthened my interest in programming and technology.",
  type: "education",
}
,
];
